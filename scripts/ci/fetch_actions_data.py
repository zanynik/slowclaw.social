...
Options:
    ...
    --repo OWNER/NAME   Repository (default: zanynik/slowclaw.social)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="zanynik/slowclaw.social",
        help="Repository in OWNER/NAME format (default: zanynik/slowclaw.social)",
    )
