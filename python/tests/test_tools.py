"""
Tests for slowclaw-tools package.
"""
...
def test_import_main():
    ...
    from slowclaw_tools import create_agent, shell, file_read, file_write
...
def test_cli_allows_interactive_without_message():
    ...
    from slowclaw_tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from slowclaw_tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from slowclaw_tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from slowclaw_tools import file_read, file_write
