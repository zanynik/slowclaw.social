...
final class AppState: ObservableObject {
    ...
    func drainPendingTranscriptions() async {
        ...
        for entry in items {
            ...
            let transcriptBody = transcript.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
            ...
            if entry.generateTitle, !transcript.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
                await generateTitleForJournal(key: entry.key, transcript: transcript)
            }
        }
