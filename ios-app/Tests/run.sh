...
cp "$APP_ROOT/SlowClawApp/NostrMedia.swift" "$TEST_ROOT/Sources/Runtime/"
...
python3 "$APP_ROOT/Tests/extract-reading-regression.py" "$APP_ROOT" "$TEST_ROOT"
cp "$APP_ROOT/Tests/ReadingRegressionTests.swift" "$APP_ROOT/Tests/NostrMediaTests.swift" "$TEST_ROOT/Tests/RuntimeTests/"
swiftc -frontend -parse "$APP_ROOT"/SlowClawApp/*.swift
cp "$APP_ROOT/Tests/RuntimeTests.swift" "$TEST_ROOT/Tests/RuntimeTests/"
cp "$APP_ROOT/Tests/CreateIdeasTests.swift" "$TEST_ROOT/Tests/RuntimeTests/"
