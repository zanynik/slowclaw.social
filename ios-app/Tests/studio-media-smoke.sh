...
lines += ['    settings:', '      base:', '        GENERATE_INFOPLIST_FILE: YES', '        PRODUCT_BUNDLE_IDENTIFIER: com.slowclaw.studio-smoke-host', '        SWIFT_VERSION: "5.9"', '        CODE_SIGNING_ALLOWED: NO', '  StudioSmoke:', '    type: bundle.unit-test', '    platform: iOS', '    sources:']
