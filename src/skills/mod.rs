...
const OPEN_SKILLS_SYNC_MARKER: &str = ".slowclaw-open-skills-sync";
const OPEN_SKILLS_SYNC_INTERVAL_SECS: u64 = 60 * 60 * 24 * 7;

/// A skill is a user-defined or community-built capability.
/// Skills live in `~/.slowclaw/workspace/skills/<name>/SKILL.md`
    ...
    match command {
        crate::SkillCommands::List => {
            ...
            if skills.is_empty() {
                ...
                println!();
                println!("  Create one: mkdir -p ~/.slowclaw/workspace/skills/my-skill");
                println!("              echo '# My Skill' > ~/.slowclaw/workspace/skills/my-skill/SKILL.md");
                println!();
...
"#,
    ...
    #[test]
    fn skills_dir_path() {
        let base = std::path::Path::new("/home/user/.slowclaw");
        let dir = skills_dir(base);
        assert_eq!(dir, PathBuf::from("/home/user/.slowclaw/skills"));
    }
