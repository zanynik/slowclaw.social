...
- [`docs/vision-contract.md`](vision-contract.md) — các bất biến định hướng sản phẩm và cổng kiểm tra theo tầm nhìn.
...
6. Giữ việc lập kế hoạch và triển khai bám sát hợp đồng tầm nhìn của sản phẩm.
...
- Contributor ánh xạ thay đổi với `docs/vision-contract.md` trong mục `Vision Alignment` khi công việc chạm tới kế hoạch, hành vi, kiến trúc hoặc luồng hướng người dùng.
...
- Các trường về căn chỉnh tầm nhìn đã được điền khi thay đổi ảnh hưởng đến hành vi, định hướng sản phẩm, hình dạng kiến trúc hoặc workflow hướng người dùng.
...
- Thay đổi phù hợp với `docs/vision-contract.md`, hoặc mọi ngoại lệ đều được nêu rõ để có thể review.
...
- Mọi xung đột với hợp đồng tầm nhìn đều đã được xử lý hoặc bị từ chối trước khi merge.
...
4. Ghi chú căn chỉnh tầm nhìn gắn với `docs/vision-contract.md` cho các thay đổi về sản phẩm, UX, nạp dữ liệu, xuất bản, tuyển chọn hoặc vector hóa.
...
- Tương thích với hợp đồng tầm nhìn.
- Ranh giới bảo mật.
